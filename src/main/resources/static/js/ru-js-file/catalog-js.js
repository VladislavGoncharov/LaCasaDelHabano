...
function checkboxType(el) {
    ...
    if (allUnchecked) {
        ...
        switch (dataName) {
            case 'cigar':
                typeNameLanguage = 'Сигара'
                break;
            case 'cigarillo':
                typeNameLanguage = 'Сигарилла'
                break;
            case 'coffee':
                typeNameLanguage = 'Кофе'
                break;
            case 'accessory':
                typeNameLanguage = 'Аксессуары'
        }
...
<!--                  <div class="text-nowrap type-name" data-idfilter="10" >${typeNameLanguage}</div>-->
                  <div class="text-nowrap type-name" data-idfilter="product" >${typeNameLanguage}</div>
                  <button class="pe-0"><img src="/img/cross_black.svg" alt="cross_black"></button>
                </div>
              `;
            $('.filters').prepend(htmlToAppend);
